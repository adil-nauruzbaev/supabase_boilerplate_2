...
abstract class AppLocalizations {
  ...
  /// No description provided for @loginNavigateToSignup.
  ///
  /// In en, this message translates to:
  /// **'Don\'t have an account? Sign up'**
  String get loginNavigateToSignup;
  ...
  /// No description provided for @signupFirstNameEmpty.
  ///
  /// In en, this message translates to:
  /// **'Please enter your first name'**
  String get signupFirstNameEmpty;
  ...
  /// No description provided for @signupEmailEmpty.
  ///
  /// In en, this message translates to:
  /// **'Please enter your email'**
  ...
  /// No description provided for @signupNavigateToLogin.
  ///
  /// In en, this message translates to:
  /// **'Already have an account? Log in'**
  String get signupNavigateToLogin;
  ...
  /// No description provided for @toastSuccessTitle.
  ///
  /// In en, this message translates to:
  /// **'Success'**
  String get toastSuccessTitle;

  /// No description provided for @toastErrorTitle.
  ///
  /// In en, this message translates to:
  /// **'Error'**
